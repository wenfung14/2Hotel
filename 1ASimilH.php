				...
				<div class="col-9" style="background-color: #f0f0f0" >
					<div class="row mt-3">
						...
						<div style="padding-left: 10px; margin-bottom: 10px;">
							<p class="ds_h"> Similkameen Wild </p>
						</div>
						<div class="col-12" > <!-- This is the main column, don't touch this -->
							...
							<div class="container-fluid mb-3" style="height: auto; border: 5px solid #000000; border-radius: 10px;">
							  <div class="mySlides">
							    ...
							    <img src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album2.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">2 / 6</div>
							    <img src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album1.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">3 / 6</div>
							    <img src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album_King_Room1.png" style="width:70%; height: 50%;">
							  </div>
							    
							  <div class="mySlides">
							    <div class="numbertext">4 / 6</div>
							    <img src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album_King_Room2.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">5 / 6</div>
							    <img src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album_King_Room3.png" style="width:70%; height: 50%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">6 / 6</div>
							    <img src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album_Queen_Room1.png" style="width:70%; height: 800px;">
							  </div>
							  ...
							  <div class="row" style="margin:0px 1px 0px 1px; ">
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album2.png" style="width:100%" onclick="currentSlide(1)" alt=" Outdoor Hotel View">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album1.png" style="width:100%" onclick="currentSlide(2)" alt="Main Hall">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album_King_Room1.png" style="width:100%" onclick="currentSlide(3)" alt="Delux Double">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album_King_Room2.png" style="width:100%" onclick="currentSlide(4)" alt="Double Delux Bathroom">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album_King_Room3.png" style="width:100%" onclick="currentSlide(5)" alt="Superior Doble">
							    </div> 
							    <br>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Canada/Similkameen Wild/SimHotel_album_Queen_Room1.png" style="width:100%; height:170px" onclick="currentSlide(6)" alt="Superior Double Bathroom">
							    </div> 
						...
						<div class="container-fluid mb-3">
							...
							<table class="hotelRT">
								...
								<?php 
									...
									$sql = "SELECT * FROM hotel_room_list WHERE roomName = 'SimilH' ;";
