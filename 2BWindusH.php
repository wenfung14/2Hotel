						...
						<div class="col-12" > <!-- This is the main column, don't touch this -->
							...
							<div class="container-fluid mb-3" style="height: auto; border: 5px solid #000000; border-radius: 10px;">
							  <div class="mySlides">
							    ...
							    <img src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album1.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">2 / 6</div>
							    <img src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album2.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">3 / 6</div>
							    <img src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album_delux_double1.png" style="width:70%; height: 50%;">
							  </div>
							    
							  <div class="mySlides">
							    <div class="numbertext">4 / 6</div>
							    <img src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album_delux_double2.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">5 / 6</div>
							    <img src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album_delux_double3.png" style="width:70%; height: 800px;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">6 / 6</div>
							    <img src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album_delux_double5.png" style="width:70%; height: 50%;">
							  </div>
							  ...
							  <div class="row" style="margin:0px 1px 0px 1px; ">
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album1.png" style="width:100%" onclick="currentSlide(1)" alt="Main Hall">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album2.png" style="width:100%" onclick="currentSlide(2)" alt="Outdoor Accessor">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album_delux_double1.png" style="width:100%" onclick="currentSlide(3)" alt="Gym Room">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album_delux_double2.png" style="width:100%" onclick="currentSlide(4)" alt="Double Delux">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album_delux_double3.png" style="width:100%; height: 200px" onclick="currentSlide(5)" alt="Hotel Pool">
							    </div> 
							    <br>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel B - 20_/Canada/Windus Inn/winHotel_album_delux_double5.png" style="width:100%" onclick="currentSlide(6)" alt="Room Toilet">
							    </div> 
						...
						<div class="container-fluid mb-3">
							...
							<table class="hotelRT">
								...
								<?php 
									...
									$sql = "SELECT * FROM hotel_room_list WHERE roomName = 'WinH' ;";
							...
							<div class="container-fluid mb-1">
								...
								<form method="POST" action="payment.php">
									<table class="hotelRT" width="100%">
										...
										<tr>
											<td style="padding: 15px">DELUXE DOUBLE ROOM</td>
											<td style="padding: 15px">
												<select name="winDeluxe">
