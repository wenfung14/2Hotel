<?php 
	...
	$date2 = $_SESSION['userDateO'] ;
	 ...
	 $_SESSION['hotelName'] = "Gurney Gold Coast"; 
	 $_SESSION['hotelState'] = "Penang";
	 $_SESSION['hotelVacc']= 1;
	 $_SESSION['hotelRoom'] = "Deluex Room";
	 $_SESSION['hotelRoom2'] = "Standard Double";
	 $_SESSION['hotelImg'] ='img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album1.png';
	 $_SESSION['hotelloc'] = "184 Persiaran Gurney, 10250 George Town, Malaysia";
				...
				<div class="col-9" style="background-color: #f0f0f0" >
					<div class="row mt-3">
						<div style="padding-left: 10px; margin-bottom: 10px;">
							<p class="ds_h">Gurney Coast By Sky Hive</p>
						</div>
						<div class="col-12" > <!-- This is the main column, don't touch this -->
							...
							<div class="container-fluid mb-3" style="height: auto; border: 5px solid #000000; border-radius: 10px;">
							  <div class="mySlides">
							    ...
							    <img src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album1.png">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">2 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album2.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">3 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album3.png" style="width:70%; height: 50%;">
							  </div>
							    
							  <div class="mySlides">
							    <div class="numbertext">4 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album6.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">5 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/standard_double_bed.png" style="width:70%; height: 50%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">6 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album4_Queen_Delux.png" style="width:70%; height: 50%;">
							  </div>
							  ...
							  <div class="row" style="margin:0px 1px 0px 1px; ">
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album1.png" style="width:100%" onclick="currentSlide(1)" alt="Outdoor Hotel View">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album2.png" style="width:100%" onclick="currentSlide(2)" alt="Hotel Drink Station">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album3.png" style="width:100%" onclick="currentSlide(3)" alt="Hotel Reception">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album6.png" style="width:100%;" onclick="currentSlide(4)" alt="Double Bed">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/standard_double_bed.png" style="width:100%" onclick="currentSlide(5)" alt="Queen Bed">
							    </div> 
							    <br>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Gurney Coast by Sky Hive/Hotel_album4_Queen_Delux.png" style="width:100%" onclick="currentSlide(6)" alt="Queen Delux">
							    </div> 
						...
						<div class="container-fluid">
							<div class="row bg-success" style="padding: 20px 0px; margin:0px 0px 20px 0px; border: 5px solid #000000; border-radius: 10px;">
								<div class="col-3">
									<i class="far fa-heart text-white" style="font-size: 80px; float: right;"></i>
								</div>

								<div class="col-9">
									<h3 class="text-white">Health &#38; Safety Measure have bene apply Hotel List</h3>
									<p class="text-white">This property has taken extra health and hygiene measures to ensure your safety is their priority</p>
								</div>
						...
						<div class="container-fluid mb-3">
							<div style="border: 5px solid #000000; padding: 20px; background-color: #d1d1d1; border-radius: 10px;">
								...
								<table width="80%" style="text-align:center;">
									...
									<tr>
										<td style="font-size: 25px; font-weight: bold;"><?php echo $_SESSION['userDateI'] ;?></td>
										<td style="font-size: 25px; font-weight: bold;"><?php echo $_SESSION['userDateO'] ;?></td>
										<td style="font-size: 25px; font-weight: bold;"><?php echo $_SESSION['numA'];?></td>
										<td style="font-size: 25px; font-weight: bold;"><?php echo $_SESSION['numC'] ;?></td>
										<td style="font-size: 25px; font-weight: bold;"><?php echo findDay($date1,$date2)." Days";?></td>
									</tr>
						...
						<div class="container-fluid mb-3">
							...
							<table class="hotelRT">
								...
								<?php 
									...
									$sql = "SELECT * FROM hotel_room_list WHERE roomName = 'GurneyGCH' ;";
							...
							<div class="container-fluid mb-1">
								...
								<form method="POST" action="payment.php">
									<table class="hotelRT" width="100%">
										...
										<tr>
											<td style="padding: 15px">QUEEN DELUEX</td>
											<td style="padding: 15px">
												<select name="gurneyDelux">
										...
										<tr>
											<td style="padding: 15px">STANDARD DOUBLE</td>
											<td style="padding: 15px">
												<select name="gurneyStandard">
												  <option disabled selected>00</option>
												  <option value="1">01</option>
												  <option value="2">02</option>
												  <option value="3">03</option>
								...
								<br>
									<button type="submit" name="subPayment" class="hotelPayment"> Proceed Payment</button>
