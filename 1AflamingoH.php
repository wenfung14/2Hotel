<?php 
	...
	include "head.php";
	 ...
	 $_SESSION['hotelName'] = "Flamingo Hotel Penang Malaysia"; 
	 $_SESSION['hotelState'] = "Penang";
	 $_SESSION['hotelVacc']= 1;
	 $_SESSION['hotelRoom'] = "Deluex Room";
	 $_SESSION['hotelRoom2'] = 	null;
	 $_SESSION['hotelImg'] ='img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album.png';
	 $_SESSION['hotelloc'] = "Jalan Tanjung Bungah, 11200 Tanjung Bungah, Pulau Pinang";
?>
				...
				<div class="col-9" style="background-color: #f0f0f0" >
					<div class="row mt-3">
						<div style="padding-left: 10px; margin-bottom: 10px;">
							<p class="ds_h">Flamingo Hotel Penang Malaysia</p>
						</div>
						<div class="col-12" > <!-- This is the main column, don't touch this -->
							...
							<div class="container-fluid mb-3" style="height: auto; border: 5px solid #000000; border-radius: 10px;">
							  <div class="mySlides">
							    ...
							    <img src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album.png">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">2 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album6.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">3 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album2.png" style="width:70%; height: 50%;">
							  </div>
							    
							  <div class="mySlides">
							    <div class="numbertext">4 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album_delux_room2.png" style="width:70%; height: 60%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">5 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album4.png" style="width:70%; height: 50%;">
							  </div>

							  <div class="mySlides">
							    <div class="numbertext">6 / 6</div>
							    <img src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album_delux_room4.png" style="width:70%; height: 50%;">
							  </div>
							  ...
							  <div class="row" style="margin:0px 1px 0px 1px; ">
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album.png" style="width:100%" onclick="currentSlide(1)" alt="Main Hall">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album6.png" style="width:100%" onclick="currentSlide(2)" alt="Outdoor Accessor">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album2.png" style="width:100%" onclick="currentSlide(3)" alt="Gym Room">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album_delux_room2.png" style="width:100%" onclick="currentSlide(4)" alt="Double Delux">
							    </div>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album4.png" style="width:100%" onclick="currentSlide(5)" alt="Hotel Pool">
							    </div> 
							    <br>
							    <div class="column">
							      <img class="demo cursor" src="img/Hotel A - 100_/Malaysia/Flamingo Hotel Penang/flaHotel_album_delux_room4.png" style="width:100%" onclick="currentSlide(6)" alt="Room Toilet">
							    </div> 
						...
						<div class="container-fluid mb-3">
							...
							<table class="hotelRT">
								...
								<?php 
									...
									$sql = "SELECT * FROM hotel_room_list WHERE roomName = 'FlamingoH' ;";
							...
							<div class="container-fluid mb-1">
								...
								<form method="POST" action="payment.php">
									<table class="hotelRT" width="100%">
										...
										<tr>
											<td style="padding: 15px">DELUEX ROOM</td>
											
											<td style="padding: 15px">
												<select name="flaDeluex">
